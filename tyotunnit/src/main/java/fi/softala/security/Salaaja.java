 ...
 * 
 * Alunperin tehnyt Jaakko Leikko @ https://github.com/jleikko
 * 
 */
public class Salaaja {
	 ...
	 */
	public static String salaa(String salattavaTeksti, String suola, String salausalgoritmi, int montakoKertaa)
